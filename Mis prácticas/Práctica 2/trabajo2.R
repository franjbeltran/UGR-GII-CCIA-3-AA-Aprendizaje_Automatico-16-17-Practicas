...
##
## Archivo .r asociado a la entrega 2.
##
###############################################################################
...
# iteraciones que se realizan y la diferencia de los valores en cada 
# iteración.
#
...
# y depende también del punto de partida que se utilice.
...
# resultados que se desean aunque si es una buena aproximación en un tiempo
# aceptable.
...
print(paste("Número de iteraciones: ", res$i))

print(paste("Ein: ", round(eLR(data, label, w)*100, digits = 3), "%"))


plot(data, main="Apartado 2a", xlab="x", ylab="y", col=label+5)

# Se añade la recta creada
abline(line[2], line[1], col=3)

abline(-(w[3]/w[2]),-(w[1]/w[2]), col=2)
...
plot(x, 
     type="p",
     main="Ejercicio 4",
     sub="Distribución Gaussiana. Media = 1, Desviación típica = 1",
     col=6)
...
# resto de En sea parecido). Se ve como es así: Ecv = 39.008%, e1 = 38.734%.
# 
